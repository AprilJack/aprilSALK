...
methSingleBP <- function(methylseqObj = "methy seq obj",nam = "name of exp",gene.obj = gene.obj,org="organism name for WebGestaltR",db="GO db's to query"){
  library("methylKit")
  library("genomation")
  library("ggplot2")
  library("gplots")
...
#  tiles <- tileMethylCounts(normed.methylseqObj,win.size=25,step.size=15)
  ...
  meth <- unite(normed.methylseqObj, destrand=FALSE)
